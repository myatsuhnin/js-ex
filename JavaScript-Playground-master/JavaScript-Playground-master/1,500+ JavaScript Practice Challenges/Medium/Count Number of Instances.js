...
Create a class named User and create a way to check the number of users (number of instances) 
...
Notes
Feel free to check out the resources provided in the Resources tab for some helpful information
