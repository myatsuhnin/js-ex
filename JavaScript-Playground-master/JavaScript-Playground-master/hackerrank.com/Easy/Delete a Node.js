...
20 6 2 7 4 15 9
Explanation
The given linked list is 20->6->2->19->7->4->15->9. We have to delete the node at position 3, 
which is 19. After deleting that node, the updated linked list is: 20->6->2->7->4->15->9
*/
...
function deleteNode(head, position) {
    ...
    let currentPos = 0;
    while (currentNode && position - 1 > currentPos) {
